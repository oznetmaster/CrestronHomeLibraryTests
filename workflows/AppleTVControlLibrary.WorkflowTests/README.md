# AppleTVControlLibrary processor workflow
...
```powershell
dotnet test workflows/AppleTVControlLibrary.WorkflowTests/AppleTVControlLibrary.WorkflowTests.csproj -c Release --list-tests
dotnet test workflows/AppleTVControlLibrary.WorkflowTests/AppleTVControlLibrary.WorkflowTests.csproj -c Release --filter FullyQualifiedName=CrestronHome.Workflows.appletvcontrollibrary_library
```
