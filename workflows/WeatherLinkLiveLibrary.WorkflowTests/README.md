# WeatherLinkLiveLibrary processor workflow
...
```powershell
dotnet test workflows/WeatherLinkLiveLibrary.WorkflowTests/WeatherLinkLiveLibrary.WorkflowTests.csproj -c Release --list-tests
dotnet test workflows/WeatherLinkLiveLibrary.WorkflowTests/WeatherLinkLiveLibrary.WorkflowTests.csproj -c Release --filter FullyQualifiedName=CrestronHome.Workflows.weatherlinklivelibrary_library
```
