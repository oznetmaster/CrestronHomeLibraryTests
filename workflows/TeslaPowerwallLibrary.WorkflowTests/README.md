# TeslaPowerwallLibrary processor workflow
...
```powershell
dotnet test workflows/TeslaPowerwallLibrary.WorkflowTests/TeslaPowerwallLibrary.WorkflowTests.csproj -c Release --list-tests
dotnet test workflows/TeslaPowerwallLibrary.WorkflowTests/TeslaPowerwallLibrary.WorkflowTests.csproj -c Release --filter FullyQualifiedName=CrestronHome.Workflows.teslapowerwalllibrary_library
```
