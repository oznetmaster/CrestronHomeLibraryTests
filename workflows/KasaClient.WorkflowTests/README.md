...
```powershell
dotnet test workflows/KasaClient.WorkflowTests/KasaClient.WorkflowTests.csproj -c Release --list-tests
dotnet test workflows/KasaClient.WorkflowTests/KasaClient.WorkflowTests.csproj -c Release --filter FullyQualifiedName=CrestronHome.Workflows.kasaclient_library
```
