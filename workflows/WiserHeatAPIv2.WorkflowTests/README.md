# WiserHeatAPIv2 processor workflow
...
```powershell
dotnet test workflows/WiserHeatAPIv2.WorkflowTests/WiserHeatAPIv2.WorkflowTests.csproj -c Release --list-tests
dotnet test workflows/WiserHeatAPIv2.WorkflowTests/WiserHeatAPIv2.WorkflowTests.csproj -c Release --filter FullyQualifiedName=CrestronHome.Workflows.wiserheatapiv2_library
```
