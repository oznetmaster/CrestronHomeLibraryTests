# OverkizClient processor workflow
...
```powershell
dotnet test workflows/OverkizClient.WorkflowTests/OverkizClient.WorkflowTests.csproj -c Release --list-tests
dotnet test workflows/OverkizClient.WorkflowTests/OverkizClient.WorkflowTests.csproj -c Release --filter FullyQualifiedName=CrestronHome.Workflows.overkizclient_library
```
