# SimpleWeather processor workflow
...
```powershell
dotnet test workflows/SimpleWeather.WorkflowTests/SimpleWeather.WorkflowTests.csproj -c Release --list-tests
dotnet test workflows/SimpleWeather.WorkflowTests/SimpleWeather.WorkflowTests.csproj -c Release --filter FullyQualifiedName=CrestronHome.Workflows.simpleweather_library
```
